...
describe('Either', function () {
  ...
  describe('#fold/#cata', function () {
    it('returns the value of a Right after applying the second function arg', function () {
      assert.equal(3, Either.Right(1).fold(R.add(1), R.add(2)));
      assert.equal(3, Either.Right(1).cata(R.add(1), R.add(2)));
    });

    it('returns the value of a Left after applying the first function arg', function () {
      assert.equal(2, Either.Left(1).fold(R.add(1), R.add(2)));
      assert.equal(2, Either.Left(1).cata(R.add(1), R.add(2)));
    });
  });

  describe('#leftMap', function () {
    it('returns a Left after mapping the passed function', function () {
      assert.ok(Either.Left(2).equals(Either.Left(1).leftMap(R.add(1))));
    });

    it('returns a Right without mapping the passed function', function () {
      assert.ok(Either.Right(1).equals(Either.Right(1).leftMap(R.add(1))));
    });
  });
